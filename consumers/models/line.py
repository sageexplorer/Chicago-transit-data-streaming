...
class Line:
    ...
    def process_message(self, message):
        ...
        if 'stations' in message.topic: # Set the conditional correctly to the stations Faust Table
            try:
        ...
        elif 'turnstiles' in message.topic: # Set the conditional to the KSQL Turnstile Summary Topic
